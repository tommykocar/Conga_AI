...
int evaluationFunction(struct Space board[4][4]) {
	...
	int numofBseeds = 0, numofWmoves = 0;
	...
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			if (board[i][j].player == black) {
				...
				if (board[i][j].player != white) continue;
				if (i - 1 >= 0 && j - 1 >= 0 && (board[i - 1][j - 1].player == openSquare || board[i - 1][j - 1].player == white)) numofWmoves++;
				if (i - 1 >= 0 && (board[i - 1][j].player == openSquare || board[i - 1][j].player == white)) numofWmoves++;
				if (i - 1 >= 0 && j + 1 < 4 && (board[i - 1][j + 1].player == openSquare || board[i - 1][j + 1].player == white))numofWmoves++;
				if (j - 1 >= 0 && (board[i][j - 1].player == openSquare || board[i][j - 1].player == white)) numofWmoves++;
				if (j + 1 < 4 && (board[i][j + 1].player == openSquare || board[i][j + 1].player == white)) numofWmoves++;
				if (i + 1 < 4 && j - 1 >= 0 && (board[i + 1][j - 1].player == openSquare || board[i + 1][j - 1].player == white)) numofWmoves++;
				if (i + 1 < 4 && (board[i + 1][j].player == openSquare || board[i + 1][j].player == white)) numofWmoves++;
				if (i + 1 < 4 && j + 1 < 4 && (board[i + 1][j + 1].player == openSquare || board[i + 1][j + 1].player == white)) numofWmoves++;



				/*if (j == 0) {
					if (i == 0) {
						if (board[i][j + 1].player == white || board[i][j + 1].player == openSquare) numofWmoves++;
						
						if (board[i + 1][j + 1].player == white || board[i + 1][j + 1].player == openSquare) numofWmoves++;
					
						if (board[i + 1][j].player == white || board[i + 1][j].player == openSquare) numofWmoves++;
					}
					else if (i == 3) {
						if (board[i][j + 1].player == white || board[i][j + 1].player == openSquare) numofWmoves++;
					...
					if (i == 0) {
						...
						if (board[i + 1][j].player == white || board[i + 1][j].player == openSquare) numofWmoves++;						if (board[i - 1][j + 1].player == white || board[i - 1][j + 1].player == openSquare) numofWmoves++;
						if (board[i - 1][j].player == white || board[i - 1][j].player == openSquare) numofWmoves++;
						if (board[i - 1][j - 1].player == white || board[i - 1][j - 1].player == openSquare) numofWmoves++;
						if (board[i + 1][j - 1].player == white || board[i + 1][j - 1].player == openSquare) numofWmoves++;
						if (board[i][j - 1].player == white || board[i][j - 1].player == openSquare) numofWmoves++;
	...
	if (numofWmoves == 0) {
		...
		return numofBseeds - numofWmoves;
	}
}
